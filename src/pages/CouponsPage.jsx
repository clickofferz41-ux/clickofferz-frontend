            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-xl p-4 mb-8 flex items-center justify-between border border-gray-100">
                    <span className="text-gray-600">
                        Showing <span className="font-bold text-textMain">{coupons.length}</span> results on this page
                    </span>
                    <Link to="/deals" className="text-primary font-medium hover:underline">View Deals Instead →</Link>
                </div>
                            ...
                            {visiblePages[0] > 1 && (
                                <>
                                    <button
                                        ...
                                        className="w-10 h-10 rounded-lg text-sm font-bold flex items-center justify-center transition-all bg-white text-gray-600 border border-gray-200 hover:border-primary hover:text-primary"
                                    >
                                        1
                                    </button>
